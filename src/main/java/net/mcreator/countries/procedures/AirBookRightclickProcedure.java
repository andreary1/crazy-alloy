...
public class AirBookRightclickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof ServerPlayer _player) {
			Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("cl:air_power"));
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(ClModItems.AIR_BOOK.get());
