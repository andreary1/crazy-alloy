...
public class MysticGroveTrunkDecorator extends TrunkVineDecorator {
	public static Codec<MysticGroveTrunkDecorator> CODEC = Codec.unit(MysticGroveTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("mystic_grove_tree_trunk_decorator", DECORATOR_TYPE));
	}
