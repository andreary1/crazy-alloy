...
package net.mcreator.countries.world.features.treedecorators;
...
public class MysticGroveLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(MysticGroveLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("mystic_grove_tree_leave_decorator", DECORATOR_TYPE));
	}

	public MysticGroveLeaveDecorator() {
		super(0.25f);
	}
