...
public class OgreEntity extends Monster {
	public OgreEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.OGRE.get(), world);
	}

	public OgreEntity(EntityType<OgreEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 8;
		setNoAi(false);
