...
public class GingerbreadHelperEntity extends Monster {
	public GingerbreadHelperEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.GINGERBREAD_HELPER.get(), world);
	}

	public GingerbreadHelperEntity(EntityType<GingerbreadHelperEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
