...
import net.mcreator.countries.procedures.StrawIceCreamZombieOnEntityTickUpdateProcedure;
import net.mcreator.countries.init.ClModEntities;

public class StrawIceCreamZombieEntity extends Monster {
	public StrawIceCreamZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.STRAW_ICE_CREAM_ZOMBIE.get(), world);
	}

	public StrawIceCreamZombieEntity(EntityType<StrawIceCreamZombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		StrawIceCreamZombieOnEntityTickUpdateProcedure.execute(this);
	}
