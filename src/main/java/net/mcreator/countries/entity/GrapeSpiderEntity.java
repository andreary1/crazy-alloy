...
public class GrapeSpiderEntity extends Monster {
	public GrapeSpiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.GRAPE_SPIDER.get(), world);
	}

	public GrapeSpiderEntity(EntityType<GrapeSpiderEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 2;
		setNoAi(false);
