...
import net.mcreator.countries.procedures.MintIceCreamZombieOnEntityTickUpdateProcedure;
import net.mcreator.countries.init.ClModEntities;

public class MintIceCreamZombieEntity extends Monster {
	public MintIceCreamZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.MINT_ICE_CREAM_ZOMBIE.get(), world);
	}

	public MintIceCreamZombieEntity(EntityType<MintIceCreamZombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		MintIceCreamZombieOnEntityTickUpdateProcedure.execute(this);
	}
