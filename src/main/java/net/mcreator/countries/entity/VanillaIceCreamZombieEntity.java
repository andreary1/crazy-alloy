...
import net.mcreator.countries.procedures.VanillaIceCreamZombieOnEntityTickUpdateProcedure;
import net.mcreator.countries.init.ClModEntities;

public class VanillaIceCreamZombieEntity extends Monster {
	public VanillaIceCreamZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.VANILLA_ICE_CREAM_ZOMBIE.get(), world);
	}

	public VanillaIceCreamZombieEntity(EntityType<VanillaIceCreamZombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		VanillaIceCreamZombieOnEntityTickUpdateProcedure.execute(this);
	}
