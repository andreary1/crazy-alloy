...
import net.mcreator.countries.procedures.ChocIceCreamZombieOnEntityTickUpdateProcedure;
import net.mcreator.countries.init.ClModEntities;

public class ChocIceCreamZombieEntity extends Monster {
	public ChocIceCreamZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClModEntities.CHOC_ICE_CREAM_ZOMBIE.get(), world);
	}

	public ChocIceCreamZombieEntity(EntityType<ChocIceCreamZombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		ChocIceCreamZombieOnEntityTickUpdateProcedure.execute(this);
	}
