...
import net.mcreator.countries.procedures.ChocolateIceCreamPlayerFinishesUsingItemProcedure;
...
public class ChocolateIceCreamItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		ChocolateIceCreamPlayerFinishesUsingItemProcedure.execute(entity);
