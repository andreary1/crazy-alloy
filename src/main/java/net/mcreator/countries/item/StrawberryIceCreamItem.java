...
import net.mcreator.countries.procedures.StrawberryIceCreamPlayerFinishesUsingItemProcedure;
import net.mcreator.countries.init.ClModItems;

public class StrawberryIceCreamItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		StrawberryIceCreamPlayerFinishesUsingItemProcedure.execute(entity);
