...
import net.mcreator.countries.procedures.UltimateIceCreamPlayerFinishesUsingItemProcedure;
...
public class UltimateIceCreamItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		UltimateIceCreamPlayerFinishesUsingItemProcedure.execute(entity);
