...
import net.mcreator.countries.procedures.VanillaIceCreamPlayerFinishesUsingItemProcedure;
...
public class VanillaIceCreamItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		VanillaIceCreamPlayerFinishesUsingItemProcedure.execute(entity);
